...
public class testCase_API_03 {
    ...
    .when().post("https://qtrip-backend.labs.crio.do/api/v1/register")
    ...
    Response response = request.post("https://qtrip-backend.labs.crio.do/api/v1/login");
   ...
   Response responseResv = requestresv.post("https://qtrip-backend.labs.crio.do/api/v1/reservations/new");
  ...
  // 3. Ensure that the booking goes fine
    ...
    .when().get("https://qtrip-backend.labs.crio.do/api/v1/reservations/")
